 ...
 * @更新版本 $
 */
public class TextFragmentPresenter {
    private IRequestGetModel mRequestGetModel = new RequestGetModel();
    private IHomeFragmentView mHomeFragmentView;
    public TextFragmentPresenter(TextFragment homeFragment){
        mHomeFragmentView = homeFragment;
    }

    public void requestGet(){
        mHomeFragmentView.showLoading();
        mRequestGetModel.getDataFromNet(Constants.BASE_URL_JOKE, mHomeFragmentView.getParamas(), new OnGetDataListener() {
            @Override
