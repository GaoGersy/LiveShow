 ...
 * @更新版本 $
 */
public class RandomJokeViewHolder extends BaseViewHolder<RandomBean.ResultBean> {

    private SimpleDraweeView mSdvImageView;
    private TextView mTvContent;

    public RandomJokeViewHolder(View itemView) {
        super(itemView);
    }
    ...
    @Override
    public void setData(RandomBean.ResultBean dataBean) {
